...
import { CardContainer, TopInfoContainer, FileInput } from './style.ts';
import editWorkerData from '../../../store/actions/editWorkerData/editWorkerData';
import ModalWrapper from '../../common/ModalWrapper/ModalWrapper.tsx';
		...
		<ModalWrapper>
			...
			>
				...
				<TextField
					...
					name="name"
					onChange={(event) =>
						editWorkerData({ name: event.target.value })
					}
				/>
				<TextField
					...
					name="salary"
					onChange={(event) =>
						editWorkerData({ salary: event.target.value })
					}
				/>
				...
				{isAdministration ? (
					<>
						<FormControl component="fieldset">
							...
							<RadioGroup
								...
								name="time"
								onChange={(event) =>
									editWorkerData({ time: event.target.value })
								}
							>
								<FormControlLabel
									value="08:00 - 14:00"
					...
					<>
						<TextField
							...
							onChange={(event) =>
								editWorkerData({
									placeNumber: event.target.value,
								})
							}
						/>
						<FormControl component="fieldset">
